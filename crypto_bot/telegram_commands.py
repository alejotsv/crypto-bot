...
WELCOME_TEXT = (
    ...
    "every 2 minutes for a Bollinger Band squeeze breakout (volatility "
    "contracts, then the bands expand back out with price above the "
    "middle band) and buys automatically when it fires.\n"
